  ...
  data () {
    return {
      ...
      imgObj: {
        ...
        '天地一号': require('../../assets/img/monster-detail-icon2.png'),
        '妖之红三兵': require('../../assets/img/monster-detail-icon3.png'),
        '龙虎之气': require('../../assets/img/monster-detail-icon4.png'),
        '黑天鹅': require('../../assets/img/monster-detail-icon5.png'),
        '壳资源大战': require('../../assets/img/monster-detail-icon6.png'),
        '人气爆棚': require('../../assets/img/monster-detail-icon7.png'),
        '上上签': require('../../assets/img/monster-detail-icon8.png'),
        '金蛋壳': require('../../assets/img/monster-detail-icon9.png'),
        '最妖送转': require('../../assets/img/monster-detail-icon10.png'),
        '牛魔王': require('../../assets/img/monster-detail-icon11.png'),
        '月度小红花': require('../../assets/img/monster-detail-icon12.png')
      },
      baseValue: {},
      timer: '',
      chartTitle: '',
